...
export const ParticleSporeCanvas: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const particles = Array.from({ length: particleCount }, () => ({
      ...
      color: Math.random() > 0.3 ? '255, 35, 65' : '6, 182, 212', // Crimson or Cyan
    ...
    const render = () => {
      ...
      particles.forEach((p) => {
        ...
        ctx.fillStyle = `rgba(${p.color}, ${Math.max(0.1, currentOpacity)})`;
