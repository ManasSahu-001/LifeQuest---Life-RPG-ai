    ...
    <div className="py-16 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="space-y-8 text-sm text-[var(--rpg-muted)] leading-relaxed">
        <div className="p-6 rounded-[var(--rpg-radius)] bg-[var(--rpg-surface)] border border-[var(--rpg-border)]">
          ...
          <p>
            LifeQuest was conceived as a hardcore RPG system first. Built with mathematical rigor, nonlinear required XP curves, data-driven attributes, and tangible city building, every click reinforces your momentum.
          </p>
        </div>
        ...
        <div className="p-6 rounded-[var(--rpg-radius)] bg-[var(--rpg-surface)] border border-[var(--rpg-border)]">
          ...
          <p className="mb-3">
            In competitive multiplayer games and high-stakes financial systems, client-side calculations are never trusted. We brought the same engineering discipline to LifeQuest:
          </p>
        ...
        <div className="p-6 rounded-[var(--rpg-radius)] bg-[var(--rpg-surface)] border border-[var(--rpg-border)]">
          ...
          <p>
            Whether you thrive in neon-lit Cyberpunk dystopias, high fantasy medieval guilds, or solarpunk ecologies, LifeQuest decouples presentation from game state. The same character, quests, and city can be experienced through radically different artistic lenses.
          </p>
        </div>
      </div>
    </div>
